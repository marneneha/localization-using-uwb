...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/neha/neha_ws2/src/localization)
  set(localization_DEVEL_PREFIX /home/neha/neha_ws2/devel)
  ...
  set(localization_INSTALL_PREFIX /home/neha/neha_ws2/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'eha <eha@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/neha/neha_ws2/src/localization/${idir}'.  ${_report}")
    endif()
    _list_append_unique(localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "uwb_start")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/neha/neha_ws2/devel/lib;/home/neha/neha_ws2/devel/lib;/home/neha/workspace/devel/lib;/home/neha/mrs_workspace/devel/lib;/opt/ros/melodic/lib)
...
set(depends "roscpp;mrs_lib;mrs_msgs;std_msgs;geometry_msgs;nav_msgs;message_runtime;gtec_msgs")
